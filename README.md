...
Early (0.3.0). You can add an IMAP mailbox, sync INBOX / Sent / Drafts / Junk, read HTML mail as designed, send through SMTP after a second confirm (a copy is APPENDed to Sent), and archive / unread / flag on the server. Attachments, POP, OAuth, and staff are still open.
